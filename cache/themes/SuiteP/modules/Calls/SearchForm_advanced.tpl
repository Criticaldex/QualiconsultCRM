...
value="1" title='' tabindex="" {$checked} >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='open_only_advanced'>{sugar_translate label='LBL_OPEN_ITEMS' module='Calls'}</label>
                            </div>
            <div class="form-item">
                                
{if strval($fields.open_only_advanced.value) == "1" || strval($fields.open_only_advanced.value) == "yes" || strval($fields.open_only_advanced.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.open_only_advanced.name}" value="0"> 
<input type="checkbox" id="{$fields.open_only_advanced.name}" 
name="{$fields.open_only_advanced.name}" 
value="1" title='' tabindex="" {$checked} >
                            </div>
        </div>
    </div>
...
{html_options id='direction_advanced' name='direction_advanced[]' options=$fields.direction_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.direction_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_start_advanced) && !empty($smarty.request.date_start_advanced)}{$smarty.request.date_start_advanced}{else}{$smarty.request.range_date_start_advanced}{/if}' title=''   size="11" class="dateRangeInput">
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_start_advanced }' title=''  tabindex='' size="11" class="rangeDateInput">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_start_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_start_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_end_advanced) && !empty($smarty.request.date_end_advanced)}{$smarty.request.date_end_advanced}{else}{$smarty.request.range_date_end_advanced}{/if}' title=''   size="11" class="dateRangeInput">
    <button id="{$id}_trigger" type="button" onclick="return false;" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar"  alt="{$APP.LBL_ENTER_DATE}"></span></button>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "range_{$id}",
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_end_advanced }' title=''  tabindex='' size="11" class="rangeDateInput">
    <button id="start_range_{$id}_trigger" type="button" onclick="return false" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "start_range_{$id}",
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_end_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_end_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
    <span class="suitepicon suitepicon-module-calendar" id="end_range_{$id}_trigger" alt="{$APP.LBL_ENTER_DATE}"></span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "end_range_{$id}",
...
<script>
    ...
    {/literal}
</script>{literal}<script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['search_form_modified_by_name_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_created_by_name_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_assigned_user_name_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_parent_name_advanced']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name_advanced","parent_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_contact_name_advanced']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_name_advanced","contact_id_advanced","contact_id_advanced","contact_id_advanced"],"required_list":["contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_of_oferta_calls_1_name_advanced']={"form":"search_form","method":"query","modules":["OF_oferta"],"group":"or","field_list":["name","id"],"populate_list":["of_oferta_calls_1_name_advanced","of_oferta_calls_1of_oferta_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_accounts_calls_1_name_advanced']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_accounts_calls_1_name_advanced","accounts_calls_1accounts_ida_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["accounts_calls_1accounts_ida"],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_colaborador_c_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["colaborador_c_advanced","user_id_c_advanced"],"required_list":["user_id_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_contacts_calls_1_name_advanced']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contacts_calls_1_name_advanced","contacts_calls_1contacts_ida_advanced","contacts_calls_1contacts_ida_advanced","contacts_calls_1contacts_ida_advanced"],"required_list":["contacts_calls_1contacts_ida"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Sin coincidencias"};</script>{/literal}