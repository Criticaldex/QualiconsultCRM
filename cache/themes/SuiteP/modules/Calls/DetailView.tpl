...
{if !$fields.tipoc_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.tipoc_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.tipoc_c.name}" value="{ $fields.tipoc_c.options }">
{ $fields.tipoc_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.tipoc_c.name}" value="{ $fields.tipoc_c.value }">
{ $fields.tipoc_c.options[$fields.tipoc_c.value]}
{/if}
{/if}
...
{if !$fields.contacts_calls_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.contacts_calls_1contacts_ida.value)}
{capture assign="detail_url"}index.php?module=Contacts&action=DetailView&record={$fields.contacts_calls_1contacts_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="contacts_calls_1contacts_ida" class="sugar_field" data-id-value="{$fields.contacts_calls_1contacts_ida.value}">{$fields.contacts_calls_1_name.value}</span>
{if !empty($fields.contacts_calls_1contacts_ida.value)}</a>{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ACCOUNTS_CALLS_1_FROM_ACCOUNTS_TITLE' module='Calls'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.accounts_calls_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.accounts_calls_1accounts_ida.value)}
{capture assign="detail_url"}index.php?module=Accounts&action=DetailView&record={$fields.accounts_calls_1accounts_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="accounts_calls_1accounts_ida" class="sugar_field" data-id-value="{$fields.accounts_calls_1accounts_ida.value}">{$fields.accounts_calls_1_name.value}</span>
{if !empty($fields.accounts_calls_1accounts_ida.value)}</a>{/if}
{/if}
...
{if !$fields.of_oferta_calls_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.of_oferta_calls_1of_oferta_ida.value)}
{capture assign="detail_url"}index.php?module=OF_oferta&action=DetailView&record={$fields.of_oferta_calls_1of_oferta_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="of_oferta_calls_1of_oferta_ida" class="sugar_field" data-id-value="{$fields.of_oferta_calls_1of_oferta_ida.value}">{$fields.of_oferta_calls_1_name.value}</span>
{if !empty($fields.of_oferta_calls_1of_oferta_ida.value)}</a>{/if}
{/if}
