<?php /* Smarty version 2.6.29, created on 2018-07-26 13:12:29
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_reports_to_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name_advanced","reports_to_id_advanced"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'popup_query_form_in_servicio_users_1_name_advanced\']={"form":"popup_query_form","method":"query","modules":["IN_Servicio"],"group":"or","field_list":["name","id"],"populate_list":["in_servicio_users_1_name_advanced","in_servicio_users_1in_servicio_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>