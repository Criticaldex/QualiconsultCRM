<?php /* Smarty version 2.6.29, created on 2018-07-26 13:12:33
         compiled from cache/themes/SuiteP/modules/Calls/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 51, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 60, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 120, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 290, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 113, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 364, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 364, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 364, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="tipoc_c"  >

<?php if (! $this->_tpl_vars['fields']['tipoc_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['tipoc_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tipoc_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tipoc_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['tipoc_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tipoc_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tipoc_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['tipoc_c']['options'][$this->_tpl_vars['fields']['tipoc_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="contacts_calls_1_name"  >

<?php if (! $this->_tpl_vars['fields']['contacts_calls_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['contacts_calls_1contacts_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Contacts&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['contacts_calls_1contacts_ida']['value']; ?>
...
"><?php endif; ?>
<span id="contacts_calls_1contacts_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['contacts_calls_1contacts_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['contacts_calls_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['contacts_calls_1contacts_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTS_CALLS_1_FROM_ACCOUNTS_TITLE','module' => 'Calls'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="relate" field="accounts_calls_1_name" colspan='3' >

<?php if (! $this->_tpl_vars['fields']['accounts_calls_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['accounts_calls_1accounts_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Accounts&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['accounts_calls_1accounts_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="accounts_calls_1accounts_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['accounts_calls_1accounts_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['accounts_calls_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['accounts_calls_1accounts_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="of_oferta_calls_1_name"  >

<?php if (! $this->_tpl_vars['fields']['of_oferta_calls_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['of_oferta_calls_1of_oferta_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=OF_oferta&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['of_oferta_calls_1of_oferta_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="of_oferta_calls_1of_oferta_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['of_oferta_calls_1of_oferta_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['of_oferta_calls_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['of_oferta_calls_1of_oferta_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
