...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='open_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPEN_ITEMS','module' => 'Calls'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strval ( $this->_tpl_vars['fields']['open_only_advanced']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['open_only_advanced']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['open_only_advanced']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['open_only_advanced']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['open_only_advanced']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['open_only_advanced']['name']; ?>
" 
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
                            </div>
...
<?php echo smarty_function_html_options(array('id' => 'direction_advanced','name' => 'direction_advanced[]','options' => $this->_tpl_vars['fields']['direction_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['direction_advanced']['value']), $this);?>
