            ...
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="index.php?module=Meetings&action=EditView&return_module=Meetings&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="Meetings" label="LBL_MODULE_NAME"}</a></li>
                        <li><a href="index.php?module=OF_oferta&action=EditView&return_module=OF_oferta&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="OF_oferta" label="LBL_MODULE_NAME"}</a></li>
                    </ul>
                </li>
